...
export default function AccountPage() {
  ...
  <div className="p-4 text-slate-700 flex flex-col items-center justify-start min-h-[40vh]">
          {loading ? (
            ...
            <div className="w-full flex flex-col items-center justify-center min-h-[40vh]">
              <div className="mb-3 text-center text-sm text-slate-700">Anda belum masuk.</div>
              <button
                onClick={() => signIn("google", { callbackUrl: "/" })}
                className="flex items-center gap-2 bg-[#fefefe] text-slate-800 text-sm font-semibold px-4 py-2 rounded-full border border-slate-300 shadow hover:shadow-md hover:border-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/40 transition"
              >
  ...
  <div className="mt-2 mb-2 text-center text-[11px] leading-5 text-slate-500">
